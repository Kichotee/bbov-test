...
const Header = () => {
  ...
  return (
    <header className="lg:sticky relative w-full overflow-hidden z-10 top-0 dark:bg-neutral-black bg-white h-16 base-theme-container flex items-center border-b border-gray-200 justify-between">
      ...
      <div className={`fixed  top-0 left-0  -translate-x-[100vw] duration-200 ${sidebarOpen && "translate-x-[0] mobile-nav "} min-h-[120vh]`}>
        <aside className="sticky top-0 left-0 border-b shadow-md  z-[100]   h-[110vh] bg-white dark:bg-neutral-black   w-[100vw] p-3 flex flex-col pl-8  lg:w-[256px] items-start transition-all min-h-[100vh]  duration-300">
